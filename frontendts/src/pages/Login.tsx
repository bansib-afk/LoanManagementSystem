...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if ((res.data as any).redirect) return;
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg bg-black border-2 border-gray-500 rounded-2xl p-6 sm:p-8 lg:p-10 shadow-lg">
